...
def new_comment(date: date, content: str, post_id: int) -> int:
    comment = CommentData(date=date, content=content, post_id=post_id)
...
# to run if we need to create the "commentdata" table - for commentss
